...
and cultural context. Includes both theoretical linguistics and practical communication skills in foreign languages."""
    ...
    superuser  = supuser.objects.create(
        id = 1,
    ...
    educator  = supuser.objects.create(
        id = 2,
        email = 'edu@gmail.com',
        first_name = 'Blossom',
        last_name = 'Ayogu',
    ...
    student  = supuser.objects.create(
        id = 3,
        email = 'stu@gmail.com',
        first_name = 'Blossom',
        last_name = 'Ayogu',
    ...
    m1, _ = module.objects.update_or_create(pk=4, defaults={"title": "Social Sciences & Humanities", "description": ss_h})
    ...
    s1, _ = submodule.objects.update_or_create(pk=1, defaults={"module_id": m1, "title": "Current Affairs", "description": "Current affairs"})

    se1, _ = section.objects.update_or_create(pk=1, defaults={"submodule_id": s1, "title": "Country", "description": "About countries"})

    t1, _ = topic.objects.update_or_create(pk=1, defaults={"section_id": se1, "title": "State and Capital", "description": "State and Capital"})
    ...
    qa, _ = quiz_attempt.objects.update_or_create(pk=1, defaults={'quiz_id': quiz, 'taken_by': student, 'score': 2, 'status': 'FIN', })
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chosen_option', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='main.option')),
