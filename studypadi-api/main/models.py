...
class Question(models.Model):
    ...
    module_id = models.OneToOneField(Module, on_delete=models.SET_NULL, null=True)
    submodule_id = models.OneToOneField(Submodule, on_delete=models.SET_NULL, null=True)
    section_id = models.OneToOneField(Section, on_delete=models.SET_NULL, null=True)
    topic_id = models.OneToOneField(Topic, on_delete=models.SET_NULL, null=True)
    created_by = models.OneToOneField(User, on_delete=models.SET_DEFAULT, default=get_super_user)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Quiz(models.Model):
    ...
    quiz_type = models.CharField(max_length=3, choices=quiz_types)
